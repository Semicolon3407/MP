...
import { Shield, Key, Layers, Eye, EyeOff, Check, MoveRight } from 'lucide-react';
    ...
    const slides = [
        {
            ...
            desc: 'Regular password updates help keep your account safe from unauthorized access',
            features: ['Enhanced Protection', 'Secure Authentication', 'Privacy Protected']
        },
        {
            Icon: Key,
            title: 'Strong Passwords',
            desc: 'Use a combination of letters, numbers, and special characters for maximum security',
            features: ['At least 8 characters', 'Mix of letters & numbers', 'Include special characters']
        },
        {
            Icon: Layers,
            title: 'Best Practices',
            desc: 'Follow security best practices to keep your account protected',
            features: ['Change password regularly', 'Use unique passwords', 'Never share credentials']
        }
    ];
        ...
        <div className="min-h-screen bg-[#040b3a] flex flex-col lg:flex-row overflow-hidden font-inter">
            ...
            <div className="w-full lg:w-[60%] flex items-center justify-center p-6 md:p-12 lg:p-20 relative bg-[#040b3a]">
                <div className="w-full max-w-[440px] relative z-10">
                    ...
                    >
                        <div className="mb-12">
                            <h1 className="text-[2.5rem] font-bold text-white mb-2 tracking-tight">Change Password</h1>
                            <p className="text-[1.0625rem] text-white/70">Update your password to keep your account secure</p>
                        </div>

                        <form className="space-y-6">
                            <div className="space-y-3">
                                <label className="text-[0.9375rem] font-medium text-white block">Current Password</label>
                            ...
                            <div className="space-y-3">
                                <label className="text-[0.9375rem] font-medium text-white block">Confirm New Password</label>
                                <div className="relative group">
                                    <input
                        ...
                        <div className="mt-12 text-center">
                            <p className="text-[0.9375rem] text-white/60">
                                Back to {' '}
                                <Link to="/my-account" className="text-accent font-bold hover:text-accent-secondary transition-colors">Account Settings</Link>
                            </p>
                        </div>
                    </motion.div>
                </div>
